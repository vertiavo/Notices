...
INSERT INTO USERCREDENTIALS (ID, USERNAME, PASSWORD) VALUES (1, 'test', 'test'), (2, 'admin', 'admin')
INSERT INTO USERGROUP (ID, GROUPNAME, USERCREDENTIALS_ID) VALUES (1, 'USERS', 1), (2, 'ADMINS', 2)
